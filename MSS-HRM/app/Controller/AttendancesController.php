 ...
 */
  ...
  public function view_query()
	...
	$this->loadModel('Employee');
        $sql = "SELECT attendances.ID,attendances.Employee_ID,InTime,OutTime,IsLate,Hours_Worked,FullName FROM attendances JOIN employees ON attendances.Employee_ID=employees.Employee_ID";
