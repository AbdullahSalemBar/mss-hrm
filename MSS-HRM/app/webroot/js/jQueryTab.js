...
var jQueryTab = {
	...
	handleEvent: function(obj){
		...
		$(self.opts.tabClass).find("li").removeClass(self.opts.activeClass)											// remove active class from all tabs
								.eq($index).addClass(self.opts.activeClass);	
		$(self.opts.tabClass).find("li .clnt_img2").removeClass('active1')											// remove active class from all tabs
								.eq($index).addClass('active1');									// add active class to this tab
